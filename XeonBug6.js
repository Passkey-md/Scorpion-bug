...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Good Night broski 🌌`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Good Evening broski 🌃`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Good Evening broski 🌃`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Good Afternoon broski 🌅`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning broski 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Good Morning broski 🌄`
 } 
...
`.trim()
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://telegra.ph/file/c14436d1e216b8cfb1f0c.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
            ...
            break
            case 'runtime':
                let runtimetext = `Bots Have Been online For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @Phanto-hacks01`,
                            thumbnailUrl: 'https://telegra.ph/file/c14436d1e216b8cfb1f0c.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
